...
function generate-minion-user-data {
  ...
  echo "LOCAL_IPV4=\`curl --silent http://169.254.169.254/2007-01-19/meta-data/local-ipv4\`"
  echo "LAST_IPV4=\$(cut -d. -f4 <<<\$LOCAL_IPV4)"
  echo "hostnamectl set-hostname node\$LAST_IPV4.kube"
